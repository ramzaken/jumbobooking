...
class Facebook
{
    ...
    {
        $appId = !empty(get_system_settings('facebook_app_id')) ? get_system_settings('facebook_app_id') : getenv(static::APP_ID_ENV_NAME);
        
        if (!$appId) {
            //throw new FacebookSDKException('Required "app_id" key not supplied in config and could not find fallback environment variable "' . static::APP_ID_ENV_NAME . '"');
        }

        $appSecret = !empty(get_system_settings('app_secret')) ? get_system_settings('app_secret') : getenv(static::APP_SECRET_ENV_NAME);
        if (!$appSecret) {
