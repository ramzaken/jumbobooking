...
Class Facebook
{
    ...
    public function __construct(){
        ...
        if (!isset($this->fb)){
            $this->fb = new FB([
                'app_id'                => get_system_settings('facebook_app_id'),
                'app_secret'            => get_system_settings('facebook_app_secret'),
                'default_graph_version' => get_system_settings('facebook_graph_version')
            ]);
        }
