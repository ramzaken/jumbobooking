...
class Paystack extends Home_Controller
{
    ...
    public function verify_customer_payment_event($ref, $booking_id, $amount) {

        $event_booking = $this->common_model->get_by_id($booking_id, 'event_booking');
            ...
            if($result){
                if($result['data']){
                    ...
                    if($result['data']['status'] == 'success'){
                        ...
                        //echo "Transaction was successful";
                        redirect(base_url('admin/payment/event_payment_success/'.$booking_id.'/paystack'));

                    }else{
                        // the transaction was not successful, do not deliver value'
                        // print_r($result);  //uncomment this line to inspect the result, to check why it failed.
                        redirect(base_url('admin/payment/payment_cancel/'.$booking_id));
    ...
    public function verify_customer_payment_product($ref, $type_id, $amount) {
            ...
            if($result){
                if($result['data']){
                    ...
                    if($result['data']['status'] == 'success'){
                        ...
                        //echo "Transaction was successful";
                        redirect(base_url('admin/payment/order_payment_success/'.$type_id.'/paystack'));
