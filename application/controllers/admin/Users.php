        ...
        {   
            ...
            if ($this->form_validation->run() === false) {
                ...
                if ($id != '') {
                    ...
                    $slug = $this->auth_model->check_username(str_slug($this->input->post('slug')));
                    if (!empty($slug)) {
                        $this->session->set_flashdata('error', trans('name-is-already-taken'));
                        redirect(base_url('admin/users'));
                        exit();
                    }
                }
                ...
                if ($id != '') {
                    ...
                    $this->admin_model->edit_option($company_data, $this->input->post('business_id'), 'business');
