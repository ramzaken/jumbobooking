                      ...
                      <div class="card-body">
                          <div class="d-flex justify-content-between mb-2">
                            ...
                            <div>
                              <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" value="1" name="enable_iyzico" class="custom-control-input" id="switch-iyz" <?php if(settings()->enable_iyzico == 1){echo "checked";} ?>>
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control" name="iyzico_mode">
                                  <option value=""><?php echo trans('select') ?></option>
                                  <option value="sandbox" <?php echo (settings()->iyzico_mode == 'sandbox') ? 'selected' : ''; ?>><?php echo trans('sandbox') ?></option>
                                  <option value="live" <?php echo (settings()->iyzico_mode == 'live') ? 'selected' : ''; ?>><?php echo trans('live') ?></option>
                              </select>
                          </div>

                          <div class="form-group">
                              <label><?php echo trans('publish-key') ?></label>
                              <input type="text" name="iyzico_api_key" value="<?php echo html_escape(settings()->iyzico_api_key); ?>" class="form-control">
                          </div>

                          <div class="form-group">
                            <label><?php echo trans('secret-key') ?> </label>
                            <input type="text" name="iyzico_secret_key" value="<?php echo html_escape(settings()->iyzico_secret_key); ?>" class="form-control">
                        </div>
                      </div>
                  </div>
