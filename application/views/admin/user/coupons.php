                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_date" class="form-control datepicker" required placeholder="" autocomplete="off" value="<?php if (isset($coupon[0]['start_date'])){echo html_escape($coupon[0]['start_date']);} ?>">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                <input type="text" name="end_date" class="form-control datepicker" required placeholder="" autocomplete="off" value="<?php if (isset($coupon[0]['end_date'])){echo html_escape($coupon[0]['end_date']);} ?>">
                                <span class="input-group-append">
                                    <button type="button" class="btn btn-default"><i class="fas fa-calendar-alt"></i></button>
                                </span>
                                </div>
