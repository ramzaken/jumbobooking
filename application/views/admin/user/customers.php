                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <select class="cus_lh form-control select2" name="time_zone" style="width: 100%;">
                              <option value=""><?php echo trans('select') ?></option>
                              <?php foreach ($time_zones as $time): ?>
                                  <option <?php if(isset($customer[0]['time_zone']) && $customer[0]['time_zone'] == $time->id){echo 'selected';} ?> value="<?php echo html_escape($time->id); ?>"><?php echo html_escape($time->name); ?>
                                  </option>
                              <?php endforeach ?>
                          </select>
                      </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                          <label><?php echo trans('customer-details') ?></label>
                          <textarea id="summernoteb" class="form-control" name="details" rows="3"><?php echo html_escape($customer[0]['details']); ?></textarea>
                      </div>
                    </div>
                                  ...
                                  <div class="btn-group">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-right" role="menu" >
                                        <a href="<?php echo base_url('admin/customers/edit/'.html_escape($row->customer_id));?>" class="dropdown-item"><?php echo trans('edit') ?></a>
                                          ...
                                          <a data-val="Category" data-id="<?php echo html_escape($row->customer_id); ?>" href="<?php echo base_url('admin/customers/disabled/'.html_escape($row->customer_id));?>" class="dropdown-item customer_disable"><?php echo trans('delete') ?></a>
