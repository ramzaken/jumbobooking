	...
	<div class="card">
		<div class="card-body">
			<ul class="nav nav-pills flex-column" id="myTab" role="tablist">
				...
				<?php if (settings()->global_wapp_msg == 0): ?>
				<li class="nav-item">
				...
				<li class="nav-item">
					<a class="nav-link <?php if(isset($page_title) && $page_title == "Meeting Settings"){echo "active";} ?>" href="<?php echo base_url('admin/settings/meeting') ?>"><i class="bi bi-person-video mr-2"></i><?php echo trans('meeting').' '.trans('settings') ?></a>
				</li>
