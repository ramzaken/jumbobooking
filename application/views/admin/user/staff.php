                          ...
                          <?php $i=1; foreach ($days as $day): ?>
                            ...
                            <div class="item-rows w-100 mb-20">
                              ...
                              <div class="col-md-8 mr-auto pl-0">
                                <?php foreach (get_time_by_days_staff($i, $this->business->uid, $staff[0]['id']) as $time): ?>
                                  <div class="hour-item mb-2 col-md-12 hideable_<?= $i; ?>" id="row_<?= $time->id ?>">
                                      <div class="row">
                                          ...
                                          <div class="col-sm-2 mb-2"><a data-id="<?= $time->id ?>" href="<?php echo base_url('admin/appointment/delete_time/'.$time->id) ?>" class="del_time_row delete_time_item text-danger"><i class="lnib lni-close"></i></a></div>
                                      </div>
                                  </div>
                                <?php endforeach ?>
                    ...
                    <table class="table table-hover text-nowrap <?php if(count($staffs) > 10){echo "datatable";} ?>">
                        ...
                        <tbody>
                          <?php $i=1; foreach ($staffs as $row): ?>
                            <tr id="row_<?php echo md5($row->id); ?>">
                                ...
                                <?php if ($this->business->enable_location == 1): ?>
                                  <td>
                                    ...
                                    <span class="badge badge-primary"><i class="fas fa-map-marker-alt"></i> <?php echo get_by_id($location->location_id, 'locations')->name; ?></span><br>

                                    <span class="badge badge-secondary"><i class="fas fa-map-marker-alt"></i> <?php echo get_by_id($location->sub_location_id, 'locations')->name; ?></span>
                                  </td>
                                <?php endif; ?>
                                ...
                                <td class="actions">
                                  <div class="btn-group">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-right" role="menu" >
                                        <a href="<?php echo base_url('admin/staff/edit/'.md5($row->id));?>" class="dropdown-item"><?php echo trans('edit') ?></a>
                                        <a data-val="Category" data-id="<?php echo md5($row->id); ?>" href="<?php echo base_url('admin/staff/delete/'.md5($row->id));?>" class="dropdown-item delete_item"><?php echo trans('delete') ?></a>
                                      </div>
                                  </div>
                                </td>
                            </tr>
