          ...
          <div class="card add_area <?php if(isset($page_title) && $page_title == "Edit Category"){echo "d-block";}else{echo "hide";} ?>">
            ...
            <div class="card-header">
              ...
              <div class="card-tools pull-right">
                <?php if (isset($page_title) && $page_title == "Edit Category"): ?>
                  <?php $required = ''; ?>
                  <a href="<?php echo base_url('admin/product/category') ?>" class="pull-right btn btn-secondary btn-sm"><i class="lni lni-arrow-left"></i> <?php echo trans('back') ?></a>
                <?php else: ?>
            ...
            <form method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/product/category_add')?>" role="form" novalidate>
              <div class="card-body">
                            ...
                            <td class="actions text-right">
                              <div class="btn-group">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right" role="menu" >
                                    <a href="<?php echo base_url('admin/product/category_edit/'.html_escape($row->id));?>" class="dropdown-item"><?php echo trans('edit') ?></a>
                                    <a data-val="Category" data-id="<?php echo html_escape($row->id); ?>" href="<?php echo base_url('admin/product/category_delete/'.html_escape($row->id));?>" class="dropdown-item delete_item"><?php echo trans('delete') ?></a>
                                  </div>
                              </div>
                            </td>
                        </tr>
