        ...
        <div class="row">
          ...
          <div class="col-lg-9 pl-3">
              ...
              <?php if (settings()->enable_wallet == 1): ?>
                  <div class="card p-3 mr-1 bg-warning-soft">
                    <span><i class="bi bi-info-circle-fill"></i> <?php echo trans('wallet-enable-alert') ?></span>
                  </div>
              <?php endif ?>
              ...
              <form method="post" action="<?php echo base_url('admin/payment/user_update') ?>" role="form" class="form-horizontal pr-20">
                ...
                <div class="card">
                  <div class="card-body">
                      <div class="d-flex justify-content-between mb-2">
                        <div>
                          <img width="100px" src="<?php echo base_url() ?>assets/images/payments/iyzico.svg">
                        </div>

                        <div>
                          <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" value="1" name="enable_iyzico" class="custom-control-input" id="switch-iyz" <?php if(user()->enable_iyzico == 1){echo "checked";} ?>>
                                <label class="custom-control-label font-weight-bold" for="switch-iyz"> </label>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                          <label><?php echo trans('payment').' '.trans('mode') ?> </label>
                          <select class="form-control" name="iyzico_mode">
                              <option value=""><?php echo trans('select') ?></option>
                              <option value="sandbox" <?php echo (user()->iyzico_mode == 'sandbox') ? 'selected' : ''; ?>><?php echo trans('sandbox') ?></option>
                              <option value="live" <?php echo (user()->iyzico_mode == 'live') ? 'selected' : ''; ?>><?php echo trans('live') ?></option>
                          </select>
                      </div>
                      ...
                      <div class="form-group">
                          <label class="control-label" for="example-input-normal"><?php echo trans('publish-key') ?></label>
                          <div class="">
                            <input type="text" name="iyzico_api_key" value="<?php echo html_escape(user()->iyzico_api_key); ?>" class="form-control" >
                          </div>
                      </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="">
                            <input type="text" name="iyzico_secret_key" value="<?php echo html_escape(user()->iyzico_secret_key); ?>" class="form-control" >
                          </div>
                      </div>
