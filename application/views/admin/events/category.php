      ...
      <div class="row">
          ...
          <div class="col-md-8 pt-3">
              ...
              <div class="category_area">
                <div class="card add_area <?php if(isset($page_title) && $page_title == "Edit Category"){echo "d-block";}else{echo "hide";} ?>">
                  ...
                  <div class="card-header">
                    ...
                    <div class="card-tools pull-right">
                      <?php if (isset($page_title) && $page_title == "Edit Category"): ?>
                        <a href="<?php echo base_url('admin/events/category') ?>" class="pull-right btn btn-secondary btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a>
                      <?php else: ?>
                  ...
                  <form method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/events/add_category')?>" role="form" novalidate>

                    <div class="card-body">

                      <div class="form-group">
                          <label><?php echo trans('name') ?> <span class="text-danger">*</span></label>
                          <input type="text" class="form-control" name="name" value="<?php if(isset($category[0]['name'])){echo html_escape($category[0]['name']);} ?>" required>
                      </div>

                      <div class="form-group">
                        <label><?php echo trans('details') ?></label>
                        <textarea id="summernote" class="form-control" name="details"><?php if(isset($category[0]['details'])){echo html_escape($category[0]['details']);} ?></textarea>
                      </div>
                ...
                <?php if (isset($page_title) && $page_title != "Edit Category"): ?>
                  <div class="card list_area">
                    <div class="card-header">
                      <?php if (isset($page_title) && $page_title == "Edit Category"): ?>
                        <h3 class="card-title pt-2">Edit <a href="<?php echo base_url('admin/events/edit_category') ?>" class="pull-right btn btn-secondary btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a></h3>
                      <?php else: ?>
                                ...
                                <td class="actions text-right">
                                  <div class="btn-group">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-right" role="menu" >
                                        <a href="<?php echo base_url('admin/events/edit_category/'.html_escape($row->id));?>" class="dropdown-item"><?php echo trans('edit') ?></a>
                                        <a data-val="Category" data-id="<?php echo html_escape($row->id); ?>" href="<?php echo base_url('admin/events/delete_category/'.html_escape($row->id));?>" class="dropdown-item delete_item"><?php echo trans('delete') ?></a>
                                      </div>
                                  </div>
                                </td>
                              </tr>
