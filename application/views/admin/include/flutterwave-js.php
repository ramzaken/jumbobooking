<script type="text/javascript">
    ...
    <?php elseif(isset($flutterwave_type) && $flutterwave_type == 'product'): ?>
        <?php 
        ...
        document.addEventListener("DOMContentLoaded", (event) => {
            ...
            getpaidSetup({
                ...
                callback: function(response) {
                    ...
                    window.location.href='<?php echo base_url('admin/payment/order_payment_success/'.html_escape($type_id).'/flutterwave') ?>';
