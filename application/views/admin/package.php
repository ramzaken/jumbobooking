                  ...
                  <div class="col-lg-4 col-sm-12 col-xs-12 text-center">
                     ...
                     <div class="pricing-table purple text-center shadow-sm">
                        ...
                        <div class="price-tag mt-0">
                          ...
                          <?php $package_slug = strtolower($package->slug); ?>
                                  ...
                                  <div class="features flex-between">
                                    <div class="feature-item-left">
                                      <?php if(isset($limit) && $limit > 0){
                                        ...
                                        if ($limit != 0) {
                                          echo "<b><i class='lnib lni-infinite'></i></b>";
                                        }
                                      }; ?> 

                                      <span class="<?php if(get_user_info() == FALSE && $all_feature->slug == 'booking-pos' || $all_feature->slug == 'deposit-service-payment'){echo "d-none";} ?>"><?php echo trans($all_feature->slug) ?></span>
                                    </div>
                                    <span class="limits <?php if(get_user_info() == FALSE && $all_feature->slug == 'booking-pos' || $all_feature->slug == 'deposit-service-payment'){echo "d-none";} ?>"><i class="<?php echo html_escape($icon); ?>"></i></span> 
                                  </div>
                                <?php endforeach ?>
                              <?php endif ?>
                          </div>
                      ...
                      <div class="card-body">
                        ...
                        <div class="row mt-50">
                          ...
                          <div class="col-md-8 p-20 plan-item">
                              ...
                              <?php $checked = ''; ?>
                              <?php $slug = strtolower($package[0]['slug']);?>
                                ...
                                <div class="custom-control custom-switch">
                                    <div class="row">
                                       <div class="col-sm-6"> 
                                          ...
                                          <label class="custom-control-label" for="switch-<?php echo html_escape($p);?>"><?php echo trans($feature->slug) ?></label>
                                          <p class="text-muted mb-2"><small><?php echo trans('enable-access-to') ?> <?php echo trans($feature->slug) ?> <?php echo trans('feature-in-this-plan') ?></small></p>
                                       </div>
