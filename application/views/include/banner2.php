...
<section class="bg-light pt-0 <?php if (isset($page_title) && $page_title == 'Company Home'){echo 'pb-12';}else{echo "p-0";} ?>">
                          ...
                          <div class="container-fluid">
                            <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarText">
                                ...
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0 smr-5">
                                    ...
                                    <li class="nav-item"><a href="<?php echo base_url('events/'.$slug) ?>" class="nav-link hdark text-<?php if (isset($page_title) && $page_title == 'Company Home'){echo 'muted';} ?> text-xs-white <?php if(isset($page_title) && $page_title == "Events"){echo "active";} ?>"><?php echo trans('events') ?></a></li>
