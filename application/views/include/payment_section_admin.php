...
<ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
    ...
    <?php if (settings()->enable_offline_payment == 1): ?>
        <li class="nav-item ml-1 mt-1 mb-3 mr-2">
            <a class="nav-link tbtns" id="pills-offline-tab" data-toggle="pill" href="#pills-offline" role="tab"
...
<div class="tab-content" id="pills-tabContent">
    ...
    <div class="tab-pane fade" id="pills-offline" role="tabpanel" aria-labelledby="pills-offline-tab">
        <?php if (settings()->enable_offline_payment == 1): ?>
            <div class="payment_area container <?php if (settings()->enable_offline_payment == 1){echo "d-show";}else{echo "d-hide";} ?>" id="mercado">
                <div class="row">
                    <div class="box col-md-12 m-auto text-center">
                        <div class="box-body text-center">
                            <div class="mt-2">
