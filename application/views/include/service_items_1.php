<div class="col-md-6 col-lg-4 mb-7" data-aos="fade-up" data-aos-delay="<?php echo $i * 100; ?>">
    ...
    <div class="card overflow-hidden rounded-lg shadow-hover border-0 transition-hover h-100">
        ...
        <div class="card-body">
            <div class="mb-6">
                ...
                <h6 class="font-weight-bold"><?php echo html_escape($service->name) ?></h6>
            </div>

            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <span class="badge badge-secondary-soft py-1 px-2 rounded-pill">
                    ...
                    <span class="ml-1 badge badge-secondary-soft py-1 px-2 rounded-pill">
