    ...
    <?php
        ...
        $customer_name = get_by_id($order->customer_id, 'customers')->name;
        $customer_email = get_by_id($order->customer_id, 'customers')->email;
        $customer_phone = get_by_id($order->customer_id, 'customers')->phone;
    ?>
                        ...
                        <div class="box col-md-12 m-auto text-center">
                            ...
                            <div class="box-body text-center">
                                ...
                                <form action="<?php echo html_escape($paypal_url); ?>" method="post" name="frmPayPal1">
                                    ...
                                    <input type="hidden" name="item_name" value="<?php echo html_escape($random_id) ?>">
                                    <input type="hidden" name="item_number" value="<?php echo html_escape($type_id) ?>">
                                    ...
                                    <input type="hidden" name="cancel_return"
                                        value="<?php echo base_url('customer/payment_msg/failed/'.html_escape($type_id)) ?>">
                                    <input type="hidden" name="return"
                                        value="<?php echo base_url('admin/payment/order_payment_success/'.html_escape($type_id).'/paypal') ?>">

                                    <div class="mt-30 mt-8">
                                        <button class="btn btn-primary paypal-btn btn-blocks w-50" href="#"><i class="fas fa-check-circle"></i> <?php echo trans('pay-now') ?></button>
                                    </div>
                                </form>
                                <!-- PRICE ITEM -->
                        ...
                        <div class="box col-md-12 m-auto text-center">
                            ...
                            <div class="credit-card-box">
                                ...
                                <div class="box-body p-0">
                                    <form role="form" action="<?php echo base_url('admin/payment/stripe_order_payment') ?>"
                                        ...
                                        <input type="hidden" name="type_id" value="<?php echo html_escape($type_id); ?>">
                                        <input type="hidden" name="type" value="<?php echo html_escape($type); ?>">
                                        <input type="hidden" name="customer_email" value="<?php echo html_escape($customer_email); ?>">
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12 mb-30">
                                                <button class="btn btn-primary paypal-btn btn-blocks w-50" type="submit"><i class="fas fa-check-circle"></i> <?php echo trans('pay-now') ?></button>
                                            </div>
                                        </div>
                        ...
                        <div class="box col-md-12 m-auto text-center">
                            <div class="box-body text-center">
                               ...
                               <?php
                                    ...
                                    $total = ($price * 100); 
                                    $amount = $price;
                                    $merchant_order_id = $type_id;
                                    $card_holder_name = $customer_name;
                                    $email = $customer_email;
                                    $phone = $customer_phone;
                                    $name = settings()->site_name;
                                    $return_url = base_url().'razorpay/user_payment_product';
                                ?>
                                ...
                                <div class="mt-4">
                                    <button id="submit-pay" type="submit" onclick="razorpaySubmit(this);" class="btn btn-primary btn-blocks w-50"> <i class="fas fa-check-circle"></i> <?php echo trans('pay-now') ?></button>
                                </div>
                        ...
                        <div class="box col-md-12 m-auto text-center">
                            <div class="box-body text-center">
                                ...
                                <div class="mt-4">
                                    ...
                                    <button type="button" onclick="payWithPaystack()" class="btn btn-primary btn-blocks w-50"><i class="fas fa-check-circle"></i> <?php echo trans('pay-now') ?> </button>
                                </div>
                        ...
                        <div class="box col-md-12 m-auto text-center">
                            <div class="box-body text-center">
                                ...
                                <div class="mt-4">
                                    ...
                                    <button type="button" id="flutterwave_payment" class="btn btn-primary btn-blocks w-50"><i class="fas fa-check-circle"></i> <?php echo trans('pay-now') ?> </button>
                                </div>
