        ...
        $(document).ready(function () {
            ...
            $datePicker.datepicker({
                ...
                onSelect: function(){
                    ...
                    var select_service_extra = $('.select_service_extra').val();
                    var service_extra_value = $('.service_extra_value').val();

                    $('.booking_date').val(date);
                    $('.pos_calendar_area').hide();
                    $('.modify_pos_date').show();
                    $(".pos_date").html('<i class="fa fa-calendar"></i> '+date);
                    $('.booking_date').val(date);
                    ...
                    var post_data = {
                        ...
                        'select_service_extra' : select_service_extra,
                        'service_extra_value' : service_extra_value,
                    };
