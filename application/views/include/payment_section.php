...
<?php $totalCost = get_appointment_price($appointment, $company); ?>


<?php if (isset($_GET['pay']) && $_GET['pay'] == 'deposit'): ?>
    <?php if ($service->deposite_type == 'fixed'): ?>
        <?php $deposit_amount = $service->deposite_amount ?>
    <?php else: ?>
        <?php $deposit_amount = ($service->deposite_percentage / 100) * $totalCost; ?>
    <?php endif ?>
    <?php $totalCost = $deposit_amount; ?>
<?php endif ?>

<?php if ($company->card_fee != 0): ?>
    <?php $totalCost = $totalCost + $company->card_fee;  ?>
<?php endif ?>


<ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
    <?php if ($user->paypal_payment == 1): ?>
        <li class="nav-item ml-1 mt-1 mb-3 mr-2">
            <a class="nav-link tbtns active" id="pills-paypal-tab" data-toggle="pill" href="#pills-paypal" role="tab"
    ...
    <?php if ($user->stripe_payment == 1): ?>
        <li class="nav-item ml-1 mt-1 mb-3 mr-2">
            <a class="nav-link tbtns btn btn-outline-primary btn-sm" id="pills-stripe-tab" data-toggle="pill" href="#pills-stripe" role="tab"
    ...
    <?php if ($user->razorpay_payment == 1): ?>
        <li class="nav-item ml-1 mt-1 mb-3 mr-2">
            <a class="nav-link tbtns btn btn-outline-primary btn-sm" id="pills-razorpay-tab" data-toggle="pill" href="#pills-razorpay" role="tab"
    ...
    <?php if ($user->paystack_payment == 1): ?>
        <li class="nav-item ml-1 mt-1 mb-3 mr-2">
            <a class="nav-link tbtns btn btn-outline-primary btn-sm" id="pills-paystack-tab" data-toggle="pill" href="#pills-paystack" role="tab"
    ...
    <?php if ($user->flutterwave_payment == 1): ?>
        <li class="nav-item ml-1 mt-1 mb-3 mr-2">
            <a class="nav-link tbtns btn btn-outline-primary btn-sm" id="pills-flutterwave-tab" data-toggle="pill" href="#pills-flutterwave" role="tab"
    ...
    <?php if ($user->mercado_payment == 1): ?>
        <li class="nav-item ml-1 mt-1 mb-3 mr-2">
            <a class="nav-link tbtns btn btn-outline-primary btn-sm" id="pills-mercado-tab" data-toggle="pill" href="#pills-mercado" role="tab"
    ...
    <?php endif ?>
     ...
     <?php if ($user->enable_iyzico == 1): ?>
        <li class="nav-item ml-1 mt-1 mb-3 mr-2">
            <a class="nav-link tbtns btn btn-outline-primary btn-sm" id="pills-iyzico-tab" data-toggle="pill" href="#pills-iyzico" role="tab"
                aria-controls="pills-iyzico" aria-selected="false"><img width="60px" src="<?php echo base_url() ?>assets/images/payments/iyzico.svg"></a>
        </li>
    <?php endif ?>

    <?php if ($user->enable_offline_payment == 1): ?>
        <li class="nav-item ml-1 mt-1 mb-3 mr-2">
            <a class="nav-link tbtns btn btn-outline-primary btn-sm" id="pills-offline-tab" data-toggle="pill" href="#pills-offline" role="tab"
...
<div class="tab-content" id="pills-tabContent">
    ...
    <div class="tab-pane fade" id="pills-iyzico" role="tabpanel" aria-labelledby="pills-iyzico-tab">
        <?php if ($user->enable_iyzico == 1): ?>
            <div class="payment_area container <?php if ($user->enable_iyzico == 1){echo "d-show";}else{echo "d-hide";} ?>" id="iyzico">
                <div class="row">
                    <div class="box col-md-12 m-auto">
                        <div class="box-body">
                            <form action="<?= base_url('admin/payment/iyzico_appointment_payment') ?>" method="POST" class="p-4 border rounded mb-3">
