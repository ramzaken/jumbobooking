                      ...
                      <div class="pricing-features text-center">
                          ...
                          <?php else: ?>
                            <?php foreach ($features as $all_feature): ?>
                              ...
                              <?php $package_slug = str_slug($package->slug); $limit = get_feature_limit($all_feature->id)->$package_slug; ?>

                              <div class="feature <?php if(settings()->enable_cdomain == 0 && $all_feature->slug == 'custom-domain'){echo "d-none";} ?>">
                                  <span class="list-style<?= $spani; ?> mr-2 <?php if(get_user_info() == FALSE && $all_feature->slug == 'deposit-service-payment'){echo "d-none";} ?> <?php if(get_user_info() == FALSE && $all_feature->slug == 'booking-pos'){echo "d-none";} ?>"><i class="<?php echo html_escape($icon); ?>"></i></span> 
                                 
                                  <span class="pt-2 <?php if(get_user_info() == FALSE && $all_feature->slug == 'deposit-service-payment'){echo "d-none";} ?> <?php if(get_user_info() == FALSE && $all_feature->slug == 'booking-pos'){echo "d-none";} ?>">
                                    <b class="text-dark">
