<div class="d-flex align-items-center position-relative min-vh-100 mb-6 mt-6">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <div class="input-group-prepend">
                                      <div class="input-group-text"><?php echo settings()->site_url; ?>/</div>
                                    </div>
                        ...
                        <!-- <div class="col-12">
                            <div class="form-group d-none">
                                <label class="mb-1">Diploma Document <span class="text-danger">*</span></label>
                                <input type="file" class="form-control form-control-sm" name="password" required>
                            </div>
                        </div> -->
                            ...
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="terms-condition">
                                    <?php echo trans('i-have-read-and-understood-the') ?> <a
                                        target="_blank" href="<?php echo base_url('page/terms-of-service') ?>"><?php echo trans('terms-and-conditions') ?></a>
                                    <?php echo trans('and') ?> <a target="_blank" href="<?php echo base_url('page/privacy-policy') ?>"> <?php echo trans('privacy-policy') ?> </a><?php echo trans('of-this-site') ?>.</label>
                            </div>
                        </div>
        ...
        <div class="w-lg-85 p-5 text-center">
            ...
            <div class="browser">
                <div class="browser-navigation-bar">
                    ...
                    <input id="slug_add" value="<?php echo settings()->site_url; ?>" disabled />
                </div>
