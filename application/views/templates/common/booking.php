                    ...
                    <div class="booking_confirm">
                        ...
                        <div class="row mt-4" data-aos="fade-up" data-aos-duration="550">
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="form-check">
                                      ...
                                      <label class="form-check-label" for="exampleRadios2">
                                        <a class="text-dark" href="<?php echo base_url('confirm_booking/'.$slug.'/'.$md5_appointment_id.'?pay=full') ?>">Pay Full Amount 
                            ...
                            <?php if ($is_embed == false): ?>
                                ...
                                <?php if ($appointment->price != 0 && $service->enable_deposite_payment != 1): ?>
