    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 m-auto">
          ...
          <a class="btn btn-primary btn-sm btn-pill mb-2 pull-right" href="<?php echo base_url('booking/'.$company->slug) ?>"><?php echo trans('book-now') ?> <i class="bi bi-arrow-right"></i></a>
